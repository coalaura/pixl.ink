...
const [RUSSELL_TO_XYZ_MATRIX, XYZ_TO_RUSSELL_MATRIX] = generateMatricesFromPrimaries(
	[
		[0.69, 0.31],
		[0.21, 0.71],
		[0.15, 0.08],
...
export default {
	name: "Russell RGB",
	long: "Russell RGB Color Space (Russell Williams)",
	css: "russell-rgb",
	...
	from: (rgb, out = {}) => {
		...
		const v3 = matmul(alloc3(), RUSSELL_TO_XYZ_MATRIX, r_lin, g_lin, b_lin);
	...
	to: (xyz, out = {}, unclamped = false) => {
		const v3 = matmul(alloc3(), XYZ_TO_RUSSELL_MATRIX, xyz.x, xyz.y, xyz.z);
